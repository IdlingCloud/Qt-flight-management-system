...
public:
    ...
    void setupUi(QDialog *Dlg_mine)
    {
        ...
        Dlg_mine->setStyleSheet(QString::fromUtf8("QLabel#lbl_cost_count{color:#4fffff }\n"
"QLabel#label_totalCost,#label_totalCost_2{color:#3db1ff}\n"
"QPushButton{background:#409eff;color:white}\n"
"QGroupBox{border: 2px solid #01ab70;border-radius: 10px;}\n"
"QGroupBox::title{font:16px; color: #01ab70;subcontrol-position: top left;}"));
        ...
        QBrush brush1(QColor(61, 177, 255, 255));
        brush1.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::Text, brush1);
        palette1.setBrush(QPalette::Active, QPalette::ButtonText, brush1);
        QBrush brush2(QColor(61, 177, 255, 128));
        ...
        editPassword->setGeometry(QRect(90, 370, 111, 51));
        QPalette palette2;
        QBrush brush3(QColor(0, 0, 0, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette2.setBrush(QPalette::Active, QPalette::WindowText, brush3);
        QBrush brush4(QColor(64, 158, 255, 255));
        ...
        btn_refresh->setGeometry(QRect(480, 370, 111, 51));
        QPalette palette15;
