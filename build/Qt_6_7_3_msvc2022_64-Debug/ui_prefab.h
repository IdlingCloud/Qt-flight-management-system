...
"QPushButton{background:#f6bd40;color:white;font:18px}\n"
...
"QLabel#lbl_before,#lbl_flghtid{color:#3fc6ff}"));
        ...
        lbl_time_start->setGeometry(QRect(150, 30, 61, 31));
        lbl_time_end = new QLabel(widget);
        lbl_time_end->setObjectName("lbl_time_end");
        lbl_time_end->setGeometry(QRect(310, 30, 61, 31));
        ...
        btn_buy->setGeometry(QRect(580, 30, 91, 41));
