...
public:
    ...
    void setupUi(QWidget *ticket)
    {
        ...
        ticket->setStyleSheet(QString::fromUtf8("QLabel#lbl_start,#lbl_end{color:rgb(85,255,255)}\n"
"QLabel#lbl_before,#lbl_flghtid{color:#0985d9}\n"
"QLabel#lbl_1,#lbl_2,#lbl_info{color:#f6bd40}\n"
"QPushButton#btn_cancel{background:#ff3333}\n"
"QLabel#lbl_date{color:white;font:18px}\n"
"QLabel#lbl_during{color: transparent}\n"
""));
        ...
        lbl_flightid->setGeometry(QRect(310, 0, 51, 19));
        ...
        lbl_during->setGeometry(QRect(260, 30, 71, 20));
        lbl_arrow = new QLabel(widget);
        lbl_arrow->setObjectName("lbl_arrow");
        lbl_arrow->setGeometry(QRect(250, 20, 81, 31));
        ...
        btn_cancel->setGeometry(QRect(600, 30, 61, 51));
        lbl_before = new QLabel(widget);
        lbl_before->setObjectName("lbl_before");
        lbl_before->setGeometry(QRect(250, 0, 61, 19));
        lbl_before->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        lbl_date = new QLabel(widget);
        lbl_date->setObjectName("lbl_date");
        lbl_date->setGeometry(QRect(240, 50, 181, 31));
        lbl_info = new QLabel(widget);
        lbl_info->setObjectName("lbl_info");
        lbl_info->setGeometry(QRect(350, 100, 161, 19));
        lbl_1 = new QLabel(widget);
        lbl_1->setObjectName("lbl_1");
        lbl_1->setGeometry(QRect(70, 100, 191, 19));
        lbl_time = new QLabel(widget);
        lbl_time->setObjectName("lbl_time");
        lbl_time->setGeometry(QRect(210, 100, 131, 20));
        lbl_2 = new QLabel(widget);
        lbl_2->setObjectName("lbl_2");
        lbl_2->setGeometry(QRect(470, 100, 251, 19));
    ...
    void retranslateUi(QWidget *ticket)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("ticket", "\346\234\272\347\245\250", nullptr));
        ...
        lbl_info->setText(QCoreApplication::translate("ticket", "\346\234\272\347\245\250\344\273\205\345\275\223\346\227\245\345\275\223\346\254\241\346\234\211\346\225\210,", nullptr));
        lbl_1->setText(QCoreApplication::translate("ticket", "\350\257\267\346\263\250\346\204\217\357\274\232\350\267\235\347\246\273\350\210\252\347\217\255\345\274\200\345\247\213", nullptr));
        ...
        lbl_2->setText(QCoreApplication::translate("ticket", "\350\257\267\345\246\245\345\226\204\345\256\211\346\216\222\346\202\250\347\232\204\346\227\266\351\227\264\357\274\201", nullptr));
    } // retranslateUi
