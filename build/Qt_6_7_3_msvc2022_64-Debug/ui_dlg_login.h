...
"QLineEdit{border-radius:5px;border:1px solid gray;min-height:24px;background-color: lightyellow;color:black}\n"
"QPushButton{border-radius:5px;background:#409eff;color: white;font: 18px, '\346\245\267\344\275\223'}\n"
